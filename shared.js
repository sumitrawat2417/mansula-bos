...
<nav class="navbar" id="navbar">
  <div class="nav-container">
    <a href="index.html" class="nav-logo">
      <img src="logo.png" alt="ManSula BOS Logo" width="32" height="32" style="border-radius:6px; object-fit:cover;" />
    ...
    <div class="footer-top">
      <div class="footer-brand">
        <a href="index.html" class="nav-logo footer-logo-link">
          <img src="logo.png" alt="ManSula BOS Logo" width="30" height="30" style="border-radius:6px; object-fit:cover;" />
